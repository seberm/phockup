...
def test_get_file_name(mocker):
    ...
    date = datetime(2017, 1, 1, 1, 1, 1, 200000)

    assert Phockup('out', rename=DEFAULT_RENAME_FORMAT).get_file_name(os.path.join("Bar", "Foo.jpg"), date) == "20170101-010101-200000.jpg"
...
def test_process_link_to_file_with_filename_date(mocker):
    ...
    if HAVE_SYMLINK:
        ...
        assert os.path.isfile(os.path.join("output", "2017", "01", "01", "20170101-010101-000000.jpg"))
    else:
...
def test_process_image_xmp(mocker):
    ...
    assert os.path.isfile(os.path.join("output", "2017", "01", "01", "20170101-010101-000000.jpg"))
    assert os.path.isfile(os.path.join("output", "2017", "01", "01", "20170101-010101-000000.jpg.xmp"))
    shutil.rmtree('output', ignore_errors=True)
...
def test_process_image_xmp_noext(mocker):
    ...
    assert os.path.isfile(os.path.join("output", "2017", "01", "01", "20170101-010101-000000.jpg"))
    assert os.path.isfile(os.path.join("output", "2017", "01", "01", "20170101-010101-000000.xmp"))
    shutil.rmtree('output', ignore_errors=True)
