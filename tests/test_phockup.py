...
# def test_dry_run():
#     shutil.rmtree('output', ignore_errors=True)
#     Phockup(['input'], 'output', dry_run=True).process()
...
#     }
#
#     assert Phockup([], 'out').get_file_name("Bar/Foo.jpg", date) == "20170101-01010120.jpg"
#
#
# def test_get_file_name_is_original_on_exception(mocker):
#     mocker.patch.object(Phockup, 'check_directories')
#     mocker.patch.object(Phockup, 'walk_directory')
#     assert Phockup([], 'out').get_file_name("Bar/Foo.jpg", None) == "Foo.jpg"
#
#
...
#     mocker.patch.object(Phockup, 'check_directories')
#     mocker.patch.object(Phockup, 'walk_directory')
#     Phockup([], 'output').process_file("input/link_to_date_20170101_010101.jpg")
#     assert os.path.isfile("output/2017/01/01/20170101-010101.jpg")
#     shutil.rmtree('output', ignore_errors=True)
#
#
...
#     mocker.patch.object(Phockup, 'check_directories')
#     mocker.patch.object(Phockup, 'walk_directory')
#     Phockup([], 'output').process_file("input/exif.jpg")
#     assert os.path.isfile("output/2017/01/01/20170101-010101.jpg")
#     shutil.rmtree('output', ignore_errors=True)
#
#
...
#     mocker.patch.object(Phockup, 'check_directories')
#     mocker.patch.object(Phockup, 'walk_directory')
#     Phockup([], 'output').process_file("input/xmp.jpg")
#     assert os.path.isfile("output/2017/01/01/20170101-010101.jpg")
...
#     mocker.patch.object(Phockup, 'check_directories')
#     mocker.patch.object(Phockup, 'walk_directory')
#     Phockup([], 'output').process_file("input/xmp_noext.jpg")
#     assert os.path.isfile("output/2017/01/01/20170101-010101.jpg")
...
#     mocker.patch.object(Phockup, 'check_directories')
#     mocker.patch.object(Phockup, 'walk_directory')
#     Phockup([], 'output').process_file("input/xmp_ext.jpg")
#     assert os.path.isfile("output/2017/01/01/20170101-010101.jpg")
#     assert os.path.isfile("output/2017/01/01/20170101-010101.xmp")
#     assert os.path.isfile("output/2017/01/01/20170101-010101.jpg.xmp")
#     shutil.rmtree('output', ignore_errors=True)
...
#         "MIMEType": "image/jpeg"
#     }
#     Phockup([], 'output').process_file("input/UNKNOWN.jpg")
...
#     mocker.patch.object(Phockup, 'check_directories')
#     mocker.patch.object(Phockup, 'walk_directory')
#     Phockup([], 'output').process_file("input/other.txt")
...
#     Phockup(['input_ignored'], 'output', exclude_regex=[r'\.DS_Store']).process()
...
#     mocker.patch.object(Phockup, 'check_directories')
#     mocker.patch.object(Phockup, 'walk_directory')
#     Phockup([], 'output', original_filenames=True).process_file("input/exif.jpg")
...
#     mocker.patch.object(Phockup, 'check_directories')
#     mocker.patch.object(Phockup, 'walk_directory')
#     Phockup([], 'output', original_filenames=True).process_file("input/UNKNOWN.jpg")
